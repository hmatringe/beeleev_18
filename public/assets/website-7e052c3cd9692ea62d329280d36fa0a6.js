...
(function() {
  (function(root, factory) {
    if ((typeof define === 'function') && define.amd) {
      return define(['utf8_encode', 'crc32', 'util', 'transformation', 'configuration', 'tags/htmltag', 'tags/imagetag', 'tags/videotag', 'cloudinary', 'cloudinaryjquery'], factory);
    } else if (typeof exports === 'object') {
...
(function() {
  var openSignInModal, setVideoSize, shouldOpenSignInModal;
  ...
  $(document).on('ready page:load', function() {
    ...
    $('a.smoothscroll').on('click', function(event) {
      ...
      if (window.location.pathname === "/") {
        ...
        return $(document).scrollTo($(fragment), 800);
      }
    });
    return setVideoSize();
  });

  shouldOpenSignInModal = function() {
    return window.location.hash === "#sign_in";
  };

  openSignInModal = function() {
    return $('#navbar-signin-btn').click();
  };

  setVideoSize = function() {
    if ($(window).width() <= 768) {
      return $('#video iframe').width('280').height('158');
    } else {
      return $('#video iframe').width('640').height('360');
    }
  };

}).call(this);
// Foudn here : http://www.cnil.fr/vos-obligations/sites-web-cookies-et-autres-traceurs/outils-et-codes-sources/la-mesure-daudience/

var tagAnalyticsCNIL = {}

tagAnalyticsCNIL.CookieConsent = function() {
    // Remplacez la valeur UA-58549371-1 par l'identifiant analytics de votre site.
    var gaProperty = 'UA-58549371-1 '
    ...
    //Affiche une  bannière d'information en haut de la page
     function showBanner(){
        ...
        // Do not show banner on phone devices
        if (screen.width < 768)
            return;
        ...
        div.innerHTML =  '<div class="navbar-fixed-top" style="background-color:#fff;text-align:center;padding:5px;font-size:12px;\
    ...
    function createInformAndAskDiv() {
        ...
        border: 1px solid #cccccc; padding :10px 10px;text-align:center; position: fixed; top:100px; \
    ...
    return {
        ...
        // La fonction d'opt-out
         ...
         hideInform: function() {
            ...
            // reset top:0px for navbar
            var div = document.getElementById("lemenu");
            div.style.top = "0px";
        },
...
(function() {
  var openApplyModal, openLoginModal, shouldOpenApplyModal, shouldOpenLoginModal;

  shouldOpenApplyModal = function() {
    return window.location.hash === "#apply";
  };

  shouldOpenLoginModal = function() {
    return window.location.hash === "#login";
  };

  openApplyModal = function() {
    $("#navbar-apply-btn").click(function() {
      return setTimeout(function() {
        return $('.toggle-sign-up-with-email').click();
      }, 1000);
    });
    return $("#navbar-apply-btn").trigger('click');
  };

  openLoginModal = function() {
    return $("#navbar-signin-btn").trigger('click');
  };

  $(document).on('ready page:load', function() {
    if (shouldOpenApplyModal()) {
      openApplyModal();
    }
    ...
    return $('#navbar-collapse-body ul.dropdown-menu li').on('click', function() {
      return $('#navbar-collapse-body').collapse('hide');
    });
  });

  $(function() {
    return $(document).on('click', '.toggle-sign-up-with-email', function() {
      $(this).toggle();
