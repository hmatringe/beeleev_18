...
(function() {
  ...
  var initCitySelect2, select2ForCities;
  ...
  $(function() {
    ...
    $('#user_country').change(function() {
      $('#user_city').val(null);
      if (select2ForCities) {
        return initCitySelect2();
      }
    });
    $('#user_spoken_languages, #user_business_sector, #user_expertises, #user_business_model, #user_international_activity_countries, #user_turnover, #user_staff_volume, #user_business_sectors').select2({
      width: 'element'
    });
    return $('#user_investment_levels').select2({
      width: '400px'
    });
  });

  initCitySelect2 = function() {
    return $('#user_city').select2({
      width: "240px",
      placeholder: "Select a city",
      minimumInputLength: 3,
      allowClear: true,
      id: function(city) {
        return city.data.accentcity;
      },
      ajax: {
      ...
      formatResult: function(data) {
        return "<div class='select2-user-result'>" + data.data.accentcity + "</div>";
      },
      formatSelection: function(data) {
        return data.data.accentcity;
      }
    });
  };
